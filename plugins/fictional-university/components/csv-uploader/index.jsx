...
export default class CSVUploader extends React.PureComponent {
  ...
  render() {
    ...
    return (
      <div className="fictional-university-block-csv-uploader">
        <h2>{__('Upload CSV', 'fictional-university')}</h2>
        <form onSubmit={this.handleSubmit}>
          ...
          <div>
            <label
              htmlFor="fictional-university-block-csv-uploader-file"
            >
              <p>
                {__(
              ...
              <input
                id="fictional-university-block-csv-uploader-file"
