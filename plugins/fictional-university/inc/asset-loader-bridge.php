...
function get_asset_dependencies( $asset ) {
	return Fictional_University\get_asset_dependencies( $asset );
}
...
function get_asset_hash( $asset ) {
	return Fictional_University\get_asset_hash( $asset );
}
...
function get_asset_path( $asset, $dir = false ) {
	return Fictional_University\get_asset_path( $asset, $dir );
}
...
function inline_locale_data( $to_handle ) {
	Fictional_University\inline_locale_data( $to_handle );
}
