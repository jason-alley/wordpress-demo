...
* fictional-university (Localization domain)
* fictional_university (Prefix for functions)
* FICTIONAL_UNIVERSITY (Prefix for constants)
* Fictional_University (Prefix for class names)
* Fictional University (Commented text)
...
non-namespaced block name (e.g., if your block is `fictional-university/my-block`,
